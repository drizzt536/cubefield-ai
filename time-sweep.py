...
ax1.plot(t, dydt[0], label="no action")
ax1.plot(t, dydt[1], label="left")
ax1.plot(t, dydt[2], label="right")

ax1.axvline(x=0, color="white", linestyle=':')
ax1.axvline(x=1, color="white", linestyle=':')

ax1.set_xlabel("elapsed time/300")
ax1.set_ylabel("d/dt model")
ax1.set_title("Numerical Derivatives")
ax1.legend()

fig2, ax2 = plt.subplots(figsize=(10, 6))
ax2.plot(t, y[0], label="no action")
ax2.plot(t, y[1], label="left")
ax2.plot(t, y[2], label="right")
